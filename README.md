...
一个 Codex skill，用来把中文内容改得自然、直接，少一点 AI 味、翻译腔、互联网黑话、概念掰扯和套话。
...
- 去掉“我们不……是因为……”“我们之所以……是因为……”这类自证式解释
- 减少“对于……而言、在……方面具有重要意义”这类翻译腔
- 减少“被……所……”“对……进行……”这类英文翻译腔
- 避免把 spectrum / continuum / primitive 直译成不合语境的“光谱、连续谱、原语”
- 减少“赋能、闭环、链路、底座、心智、生态、方法论”这类互联网黑话
- 减少“不是……而是……”“真正的……是……”这类概念掰扯
- 把“提升体验、降低门槛、打造闭环”改成具体行为
- 优先平铺直叙，少解释、少拔高、少自我证明
- 保留必要术语、事实、约束和原本语气
